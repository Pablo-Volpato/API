...
public class ItemPedidoService {
	...
	public Optional<ItemPedidoDTO> buscarItemPedidoId(Long id) {
		...
		itemPedidoPedidoDTO.setId(itemPedido.get().getId());
		itemPedidoPedidoDTO.setQuantidade(itemPedido.get().getQuantidade());
		itemPedidoPedidoDTO.setIdPedido(itemPedido.get().getPedido().getId());
		...
		itemPedidoPedidoDTO.setSubValor(itemPedido.get().getSubValor());
